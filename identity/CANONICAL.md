...
- **Authority chain:** koad → Juno → muse
- **Cryptographic identity:** Keys in ~/.muse/id/
- **Located at:** $HOME = ~/.muse
- **Repository:** koad/muse (GitHub)
- **Git identity:** Muse <muse@kingofalldata.com>
